function [X, fX, i] = minimize(X, f, length, silentflag, varargin)
% Modified by Peter Sadowski Aug 12th 2012
...
% silentflag = true to suppress commandline output. Option added by Peter.
...
MAX = 20;   %20;                      % max 20 function evaluations per line search
...
if ~silentflag, fprintf('%s %6i;  Value %4.6e\r', S, i, f0); end;
