classdef netdt_dropout < netdt
% Net trained with deep target algorithm and dropout.
    properties
        notdrop = 10; % Dropout all but this number of nodes.
    end
    methods
        function self = netdt_dropout(varargin)
            ...
            for i = 1:self.nepoch
                for j = 1:nbatch
                    for k = 1:self.nlayers
                        ...
                        notdropidx = randperm(self.layers{k}.NumOutputs, self.notdrop);
